...
public class InterfacePrompts {
    ...
    public static long promptPhone(String promptText) {
        while(true) {
            try {
                return Long.parseLong(promptLineRegex(promptText, "[\\s\\W]+", "^[0-9]*$", "That is not a valid phone number. Please enter a phone number, optionally containing an international calling code. For instance, enter 123-456-7890 or 1-123-456-7890."));
            } catch (Exception ex) {
